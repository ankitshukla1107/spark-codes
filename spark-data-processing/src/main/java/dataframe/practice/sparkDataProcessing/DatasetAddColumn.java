...
public class DatasetAddColumn {
	...
	public static void main(String[] args) {
		// configure spark
		SparkSession spark = SparkSession.builder().appName("Spark Example - Add a new Column to Dataset")
				.master("local[2]").getOrCreate();

		String jsonPath = "E:\\code\\git-2018\\spark-codes\\spark-data-processing\\src\\main\\java\\dataframe\\practice\\sparkDataProcessing\\people.json";
