...
public class GroupByExample {
	public static void main(String[] args) throws Exception {
		...
		JavaRDD<String> rddX = sc.parallelize(Arrays.asList("Joseph", "Jimmy",
				"Tina", "Thomas", "James", "Cory", "Christine", "Jackeline",
				"Juan"), 3);

		JavaPairRDD<Character, Iterable<String>> rddY = rddX
